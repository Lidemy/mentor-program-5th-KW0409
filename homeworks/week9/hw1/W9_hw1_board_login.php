  ...
  <main class="board">
    <div class="board__top">
      ...
      <div class="user__btn-area">
        <a class="to__board" href="./W9_hw1_board_index(ver_session).php">回留言板</a>
        <a class="to__login" href="./W9_hw1_board_register.php">註冊</a>
      </div>
    </div>
    ...
    <form class="board__comment-form register__form" method="POST" action="W9_hw1_board_handle_login(ver_session).php">
